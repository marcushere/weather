...
public class WeatherGUI extends javax.swing.JFrame implements WeatherUI{
	...
	@Override
	public void threadOutMessage(String str, int threadID, int errorlevel) {
		// TODO Auto-generated method stub
    ...
    private void initComponents() {
        ...
        threadComboBox = new javax.swing.JComboBox<String>();
        debugComboLabel = new javax.swing.JLabel();
        debugComboBox = new javax.swing.JComboBox<String>();
        ...
        t1List.setModel(new javax.swing.AbstractListModel<String>() {
        ...
        t2List.setModel(new javax.swing.AbstractListModel<String>() {
        ...
        t3List.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        t4List.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        t5List.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        t6List.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        t7List.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        t8List.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        threadComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "2", "3", "4", "5", "6", "7", "8" }));
        ...
        debugComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "(0) None", "(1) Error", "(2) Warning", "(3) Message", "(4) Progress" }));
        ...
        writeToDBSwitch.setSelected(true);
    ...
    private void runButtonActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_runButtonActionPerformed
        if (runButton.getText().equals("Run")) {
            ...
            boolean debugEnabled = debugSwitch.isSelected();
            boolean simRunEnabled = simRunSwitch.isSelected();
            boolean ignoreEnabled = ignoreSwitch.isSelected();
            boolean forceEnabled = forceSwitch.isSelected();
            int threadComboVal = threadComboBox.getSelectedIndex() + 1;
            int debugComboVal = debugComboBox.getSelectedIndex() + 1;
            config.setDebug(debugEnabled);
            if (debugEnabled){
            config.setVerbosity(debugComboVal);
            }else{
                config.setVerbosity(1);
            }
            config.setRunTerminal(false);
            config.setPastOnly(false);
            config.setForceRun(forceEnabled);
            config.setSimRun(simRunEnabled);
            if(simRunEnabled){
                config.setLOG_NAME("log_alt.txt");
            }
            config.setIgnoreLog(ignoreEnabled);
            config.setNumThreads(threadComboVal);
            try {
				if (config.finishedToday()&&!config.isIgnoreLog()){ mainOutMessage("Already finished today", 1);}
			} catch (IOException e) {
				Util.exceptionHandler(e, 1,
						"WT.run> Unknown error, probably a problem reading logfile", config, this);
			}
            config.outputConfig(this);
            wr = new WeatherRecorder(this, config);
            wr.run();
...
//            }
    ...
    private javax.swing.JComboBox<String> debugComboBox;
